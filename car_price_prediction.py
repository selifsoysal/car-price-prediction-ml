...
# Grafik (SVR)
plt.figure(figsize=(8, 6))
plt.scatter(y_test_real, y_pred_svm_real, alpha=0.5, color='orange')
plt.plot([y_test_real.min(), y_test_real.max()], [y_test_real.min(), y_test_real.max()], 'r--', lw=2)
plt.xlabel("Gerçek Fiyat")
plt.ylabel("Tahmin Edilen Fiyat")
plt.title("SVM: Gerçek vs Tahmin Edilen Fiyat")
plt.grid(True)
plt.tight_layout()
plt.show()
...
# Grafik (KNN)
plt.figure(figsize=(8, 6))
plt.scatter(y_test_real, y_pred_knn_real, alpha=0.5, color='green')
plt.plot([y_test_real.min(), y_test_real.max()], [y_test_real.min(), y_test_real.max()], 'r--', lw=2)
plt.xlabel("Gerçek Fiyat")
plt.ylabel("Tahmin Edilen Fiyat")
plt.title("KNN: Gerçek vs Tahmin Edilen Fiyat")
plt.grid(True)
plt.tight_layout()
plt.show()
...
# Grafik (LR)
plt.figure(figsize=(8, 6))
plt.scatter(y_test_real, y_pred_lr_real, alpha=0.5, color='purple')
plt.plot([y_test_real.min(), y_test_real.max()], [y_test_real.min(), y_test_real.max()], 'r--', lw=2)
plt.xlabel("Gerçek Fiyat")
plt.ylabel("Tahmin Edilen Fiyat")
plt.title("Linear Regression: Gerçek vs Tahmin Edilen Fiyat")
plt.grid(True)
plt.tight_layout()
plt.show()
